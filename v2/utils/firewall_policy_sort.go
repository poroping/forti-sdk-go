...
const utilsFirewallPolicyPath = "firewall/policy/"
...
func (c *Client) utilsGetFirewallPolicyList(params *models.CmdbRequestParams) (policyList *[]utilsFirewallPolicy, err error) {
	...
	req.HTTPMethod = "GET"
	req.Payload = nil
	req.Path = models.CmdbBasePath + utilsFirewallPolicyPath
	req.Params = *params
...
func (c *Client) utilsMoveAfterFirewallPolicy(policyMoved, policyTarget int) (err error) {
	...
	req.HTTPMethod = "PUT"
	req.Payload = nil
	req.Path = models.CmdbBasePath + utilsFirewallPolicyPath + idMoved
	req.Params = *params
