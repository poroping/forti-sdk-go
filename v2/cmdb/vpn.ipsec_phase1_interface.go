...
func (c *Client) ReadVpnIpsecPhase1Interface(mkey string, params *models.CmdbRequestParams) (*models.VpnIpsecPhase1Interface, error) {
	...
	req.Mkey = &mkey
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.VpnIpsecPhase1InterfacePath + url.QueryEscape(mkey) + "/"
	req.Params = *params
...
func (c *Client) ListVpnIpsecPhase1Interface(params *models.CmdbRequestParams) (*[]models.VpnIpsecPhase1Interface, error) {
	req := &models.CmdbRequest{}
	req.HTTPMethod = "GET"
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.VpnIpsecPhase1InterfacePath
