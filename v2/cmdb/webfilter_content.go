...
func (c *Client) ReadWebfilterContent(mkey string, params *models.CmdbRequestParams) (*models.WebfilterContent, error) {
	...
	req.Mkey = &mkey
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.WebfilterContentPath + url.QueryEscape(mkey) + "/"
	req.Params = *params
...
func (c *Client) ListWebfilterContent(params *models.CmdbRequestParams) (*[]models.WebfilterContent, error) {
	req := &models.CmdbRequest{}
	req.HTTPMethod = "GET"
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.WebfilterContentPath
