...
func (c *Client) UpdateSystemSessionTtl(mkey string, payload *models.SystemSessionTtl, params *models.CmdbRequestParams) (*models.CmdbResponse, error) {
