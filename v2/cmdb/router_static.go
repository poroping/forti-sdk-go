...
func (c *Client) ReadRouterStatic(mkey string, params *models.CmdbRequestParams) (*models.RouterStatic, error) {
	...
	req.Mkey = &mkey
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.RouterStaticPath + url.QueryEscape(mkey) + "/"
	req.Params = *params
...
func (c *Client) ListRouterStatic(params *models.CmdbRequestParams) (*[]models.RouterStatic, error) {
	req := &models.CmdbRequest{}
	req.HTTPMethod = "GET"
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.RouterStaticPath
