...
func (c *Client) ReadVpnSslWebRealm(mkey string, params *models.CmdbRequestParams) (*models.VpnSslWebRealm, error) {
	...
	req.Mkey = &mkey
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.VpnSslWebRealmPath + url.QueryEscape(mkey) + "/"
	req.Params = *params
...
func (c *Client) ListVpnSslWebRealm(params *models.CmdbRequestParams) (*[]models.VpnSslWebRealm, error) {
	req := &models.CmdbRequest{}
	req.HTTPMethod = "GET"
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.VpnSslWebRealmPath
