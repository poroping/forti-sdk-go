...
func (c *Client) ReadRouterIsisIsisNet(mkey string, params *models.CmdbRequestParams) (*models.RouterIsisIsisNet, error) {
	...
	req.Mkey = &mkey
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.RouterIsisIsisNetPath + url.QueryEscape(mkey) + "/"
	req.Params = *params
...
func (c *Client) ListRouterIsisIsisNet(params *models.CmdbRequestParams) (*[]models.RouterIsisIsisNet, error) {
	req := &models.CmdbRequest{}
	req.HTTPMethod = "GET"
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.RouterIsisIsisNetPath
