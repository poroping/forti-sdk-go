...
func (c *Client) ReadVpnIpsecManualkeyInterface(mkey string, params *models.CmdbRequestParams) (*models.VpnIpsecManualkeyInterface, error) {
	...
	req.Mkey = &mkey
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.VpnIpsecManualkeyInterfacePath + url.QueryEscape(mkey) + "/"
	req.Params = *params
...
func (c *Client) ListVpnIpsecManualkeyInterface(params *models.CmdbRequestParams) (*[]models.VpnIpsecManualkeyInterface, error) {
	req := &models.CmdbRequest{}
	req.HTTPMethod = "GET"
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.VpnIpsecManualkeyInterfacePath
