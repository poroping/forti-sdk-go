...
func (c *Client) ReadSystemReplacemsgHttp(mkey string, params *models.CmdbRequestParams) (*models.SystemReplacemsgHttp, error) {
	...
	req.Mkey = &mkey
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.SystemReplacemsgHttpPath + url.QueryEscape(mkey) + "/"
	req.Params = *params
...
func (c *Client) DeleteSystemReplacemsgHttp(mkey string, params *models.CmdbRequestParams) error {
	payload := &models.SystemReplacemsgHttp{}
	payload.Defaults()
	_, err := c.UpdateSystemReplacemsgHttp("", payload, params)
	return err
}

func (c *Client) ListSystemReplacemsgHttp(params *models.CmdbRequestParams) (*[]models.SystemReplacemsgHttp, error) {
	req := &models.CmdbRequest{}
	req.HTTPMethod = "GET"
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.SystemReplacemsgHttpPath
