...
func (c *Client) UpdateSystemFssoPolling(mkey string, payload *models.SystemFssoPolling, params *models.CmdbRequestParams) (*models.CmdbResponse, error) {
