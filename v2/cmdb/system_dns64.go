...
func (c *Client) ReadSystemDns64(mkey string, params *models.CmdbRequestParams) (*models.SystemDns64, error) {
	...
	req.Mkey = &mkey
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.SystemDns64Path
	req.Params = *params
...
func (c *Client) UpdateSystemDns64(mkey string, payload *models.SystemDns64, params *models.CmdbRequestParams) (*models.CmdbResponse, error) {
