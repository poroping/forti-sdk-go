...
func (c *Client) ReadFirewallServiceCustom(mkey string, params *models.CmdbRequestParams) (*models.FirewallServiceCustom, error) {
	...
	req.Mkey = &mkey
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.FirewallServiceCustomPath + url.QueryEscape(mkey) + "/"
	req.Params = *params
...
func (c *Client) ListFirewallServiceCustom(params *models.CmdbRequestParams) (*[]models.FirewallServiceCustom, error) {
	req := &models.CmdbRequest{}
	req.HTTPMethod = "GET"
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.FirewallServiceCustomPath
