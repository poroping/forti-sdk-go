...
func (c *Client) ReadFirewallMulticastAddress(mkey string, params *models.CmdbRequestParams) (*models.FirewallMulticastAddress, error) {
	...
	req.Mkey = &mkey
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.FirewallMulticastAddressPath + mkey + "/"
	req.Params = *params
...
func (c *Client) ListFirewallMulticastAddress(mkey string, params *models.CmdbRequestParams) (*[]models.FirewallMulticastAddress, error) {
	req := &models.CmdbRequest{}
	req.HTTPMethod = "GET"
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.FirewallMulticastAddressPath
