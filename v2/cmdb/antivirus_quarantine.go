...
func (c *Client) ReadAntivirusQuarantine(mkey string, params *models.CmdbRequestParams) (*models.AntivirusQuarantine, error) {
	...
	req.Mkey = &mkey
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.AntivirusQuarantinePath
	req.Params = *params
...
func (c *Client) UpdateAntivirusQuarantine(mkey string, payload *models.AntivirusQuarantine, params *models.CmdbRequestParams) (*models.CmdbResponse, error) {
