...
func (c *Client) ReadFirewallConsolidatedPolicy(mkey string, params *models.CmdbRequestParams) (*models.FirewallConsolidatedPolicy, error) {
	...
	req.Mkey = &mkey
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.FirewallConsolidatedPolicyPath + url.QueryEscape(mkey) + "/"
	req.Params = *params
...
func (c *Client) ListFirewallConsolidatedPolicy(params *models.CmdbRequestParams) (*[]models.FirewallConsolidatedPolicy, error) {
	req := &models.CmdbRequest{}
	req.HTTPMethod = "GET"
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.FirewallConsolidatedPolicyPath
