...
func (c *Client) ReadSystemFederatedUpgrade(mkey string, params *models.CmdbRequestParams) (*models.SystemFederatedUpgrade, error) {
	...
	req.Mkey = &mkey
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.SystemFederatedUpgradePath
	req.Params = *params
	...
	if tmp, ok := res.Results.(interface{}); ok {
		...
		v := models.SystemFederatedUpgrade{}
...
func (c *Client) UpdateSystemFederatedUpgrade(mkey string, payload *models.SystemFederatedUpgrade, params *models.CmdbRequestParams) (*models.CmdbResponse, error) {
