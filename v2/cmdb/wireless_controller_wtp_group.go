...
func (c *Client) CreateWirelessControllerWtpGroup(payload *models.WirelessControllerWtpGroup, params *models.CmdbRequestParams) (*models.CmdbResponse, error) {
	...
	if payload.Name != nil && *params.AllowAppend {
		mkey = *payload.Name
		read, err := c.ReadWirelessControllerWtpGroup(mkey, params)
		if err != nil {
			return nil, err
		}
		if read != nil {
			log.Printf("[WARN] Resource at path %q with mkey %q detected upon CREATE with flag set to to overwrite. Changing to UPDATE.", models.WirelessControllerWtpGroupPath, mkey)
			return c.UpdateWirelessControllerWtpGroup(mkey, payload, params)
		}
	}
...
func (c *Client) ReadWirelessControllerWtpGroup(mkey string, params *models.CmdbRequestParams) (*models.WirelessControllerWtpGroup, error) {
	...
	req.Mkey = &mkey
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.WirelessControllerWtpGroupPath + url.QueryEscape(mkey) + "/"
	req.Params = *params
...
func (c *Client) ListWirelessControllerWtpGroup(params *models.CmdbRequestParams) (*[]models.WirelessControllerWtpGroup, error) {
	req := &models.CmdbRequest{}
	req.HTTPMethod = "GET"
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.WirelessControllerWtpGroupPath
