...
func (c *Client) ReadFirewallVendorMacSummary(mkey string, params *models.CmdbRequestParams) (*models.FirewallVendorMacSummary, error) {
	...
	if tmp, ok := res.Results.(interface{}); ok {
		...
		v := models.FirewallVendorMacSummary{}
...
func (c *Client) UpdateFirewallVendorMacSummary(mkey string, payload *models.FirewallVendorMacSummary, params *models.CmdbRequestParams) (*models.CmdbResponse, error) {
