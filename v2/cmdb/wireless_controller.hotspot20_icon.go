...
func (c *Client) ReadWirelessControllerHotspot20Icon(mkey string, params *models.CmdbRequestParams) (*models.WirelessControllerHotspot20Icon, error) {
	...
	req.Mkey = &mkey
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.WirelessControllerHotspot20IconPath + url.QueryEscape(mkey) + "/"
	req.Params = *params
...
func (c *Client) ListWirelessControllerHotspot20Icon(params *models.CmdbRequestParams) (*[]models.WirelessControllerHotspot20Icon, error) {
	req := &models.CmdbRequest{}
	req.HTTPMethod = "GET"
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.WirelessControllerHotspot20IconPath
