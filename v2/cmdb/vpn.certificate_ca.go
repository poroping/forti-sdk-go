...
func (c *Client) ReadVpnCertificateCa(mkey string, params *models.CmdbRequestParams) (*models.VpnCertificateCa, error) {
	...
	req.Mkey = &mkey
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.VpnCertificateCaPath + url.QueryEscape(mkey) + "/"
	req.Params = *params
...
func (c *Client) ListVpnCertificateCa(params *models.CmdbRequestParams) (*[]models.VpnCertificateCa, error) {
	req := &models.CmdbRequest{}
	req.HTTPMethod = "GET"
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.VpnCertificateCaPath
