...
func (c *Client) ReadWirelessControllerGlobal(mkey string, params *models.CmdbRequestParams) (*models.WirelessControllerGlobal, error) {
	...
	req.Mkey = &mkey
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.WirelessControllerGlobalPath
	req.Params = *params
	...
	if tmp, ok := res.Results.(interface{}); ok {
		...
		v := models.WirelessControllerGlobal{}
...
func (c *Client) UpdateWirelessControllerGlobal(mkey string, payload *models.WirelessControllerGlobal, params *models.CmdbRequestParams) (*models.CmdbResponse, error) {
