...
func (c *Client) ReadSystemNdProxy(mkey string, params *models.CmdbRequestParams) (*models.SystemNdProxy, error) {
	...
	req.Mkey = &mkey
	req.Payload = nil
	req.Path = models.CmdbBasePath + models.SystemNdProxyPath
	req.Params = *params
...
func (c *Client) UpdateSystemNdProxy(mkey string, payload *models.SystemNdProxy, params *models.CmdbRequestParams) (*models.CmdbResponse, error) {
