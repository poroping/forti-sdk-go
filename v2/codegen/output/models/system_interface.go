...
type SystemInterface struct {
	...
	AtmProtocol                           *string                                 `json:"atm-protocol,omitempty"`
	...
	MuxType                               *string                                 `json:"mux-type,omitempty"`
	...
	PhyMode                               *string                                 `json:"phy-mode,omitempty"`
	...
	Retransmission                        *string                                 `json:"retransmission,omitempty"`
	...
	TcMode                                *string                                 `json:"tc-mode,omitempty"`
	...
	Vci                                   *int64                                  `json:"vci,omitempty"`
	Vdom                                  *string                                 `json:"vdom,omitempty"`
	Vectoring                             *string                                 `json:"vectoring,omitempty"`
