...
type CertificateLocal struct {
	...
	AcmeRenewWindow           *float64 `json:"acme-renew-window,omitempty"`
	AcmeRsaKeySize            *float64 `json:"acme-rsa-key-size,omitempty"`
	AutoRegenerateDays        *float64 `json:"auto-regenerate-days,omitempty"`
	AutoRegenerateDaysWarning *float64 `json:"auto-regenerate-days-warning,omitempty"`
