...
type SystemGlobal struct {
	...
	AdminForticloudSsoDefaultProfile      *string `json:"admin-forticloud-sso-default-profile,omitempty"`
	AdminForticloudSsoLogin               *string `json:"admin-forticloud-sso-login,omitempty"`
	AdminHost                             *string `json:"admin-host,omitempty"`
	...
	EarlyTcpNpuSession                    *string `json:"early-tcp-npu-session,omitempty"`
	...
	FortiextenderProvisionOnAuthorization *string `json:"fortiextender-provision-on-authorization,omitempty"`
	...
	GuiAppDetectionSdwan                  *string `json:"gui-app-detection-sdwan,omitempty"`
	GuiAutoUpgradeSetupWarning            *string `json:"gui-auto-upgrade-setup-warning,omitempty"`
	...
	GuiFortiguardResourceFetch            *string `json:"gui-fortiguard-resource-fetch,omitempty"`
	...
	HyperScaleVdomNum                     *int64  `json:"hyper-scale-vdom-num,omitempty"`
	IgmpStateLimit                        *int64  `json:"igmp-state-limit,omitempty"`
	InterfaceSubnetUsage                  *string `json:"interface-subnet-usage,omitempty"`
	InternetServiceDatabase               *string `json:"internet-service-database,omitempty"`
	Interval                              *int64  `json:"interval,omitempty"`
	IpFragmentMemThresholds               *int64  `json:"ip-fragment-mem-thresholds,omitempty"`
	...
	IpsecRoundRobin                       *string `json:"ipsec-round-robin,omitempty"`
	...
	Ipv6AllowLocalInSilentDrop            *string `json:"ipv6-allow-local-in-silent-drop,omitempty"`
	Ipv6AllowLocalInSlientDrop            *string `json:"ipv6-allow-local-in-slient-drop,omitempty"`
	Ipv6AllowMulticastProbe               *string `json:"ipv6-allow-multicast-probe,omitempty"`
	...
	LogSingleCpuHigh                      *string `json:"log-single-cpu-high,omitempty"`
	...
	NpuNeighborUpdate                     *string `json:"npu-neighbor-update,omitempty"`
	...
	ProxyKeepAliveMode                    *string `json:"proxy-keep-alive-mode,omitempty"`
	...
	ProxyReAuthenticationTime             *int64  `json:"proxy-re-authentication-time,omitempty"`
	...
	SflowdMaxChildrenNum                  *int64  `json:"sflowd-max-children-num,omitempty"`
	...
	SplitPort                             *string `json:"split-port,omitempty"`
	...
	SyslogAffinity                        *string `json:"syslog-affinity,omitempty"`
	...
	WadRestartEndTime                     *string `json:"wad-restart-end-time,omitempty"`
	WadRestartMode                        *string `json:"wad-restart-mode,omitempty"`
	WadRestartStartTime                   *string `json:"wad-restart-start-time,omitempty"`
