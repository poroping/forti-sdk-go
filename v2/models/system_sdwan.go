...
type SystemSdwanDuplication struct {
	...
	SlaMatchService     *string                            `json:"sla-match-service,omitempty"`
...
type SystemSdwanHealthCheck struct {
	...
	MosCodec                   *string                          `json:"mos-codec,omitempty"`
	Name                       *string                          `json:"name,omitempty"`
...
type SystemSdwanNeighbor struct {
	...
	Member                *[]SystemSdwanNeighborMember `json:"member,omitempty"`
...
type SystemSdwanNeighborMember struct {
	SeqNum *int64 `json:"seq-num,omitempty"`
}
...
type SystemSdwanService struct {
	...
	InputZone                      *[]SystemSdwanServiceInputZone                      `json:"input-zone,omitempty"`
	...
	InternetServiceAppCtrlCategory *[]SystemSdwanServiceInternetServiceAppCtrlCategory `json:"internet-service-app-ctrl-category,omitempty"`
