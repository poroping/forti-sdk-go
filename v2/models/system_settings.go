...
type SystemSettings struct {
	...
	DetectUnknownEsp                *string                                  `json:"detect-unknown-esp,omitempty"`
	...
	DynAddrSessionCheck             *string                                  `json:"dyn-addr-session-check,omitempty"`
	EcmpMaxPaths                    *int64                                   `json:"ecmp-max-paths,omitempty"`
	EmailPortalCheckDns             *string                                  `json:"email-portal-check-dns,omitempty"`
	ExtResourceSessionCheck         *string                                  `json:"ext-resource-session-check,omitempty"`
	FirewallSessionDirty            *string                                  `json:"firewall-session-dirty,omitempty"`
	FqdnSessionCheck                *string                                  `json:"fqdn-session-check,omitempty"`
	...
	GuiAdvancedWirelessFeatures     *string                                  `json:"gui-advanced-wireless-features,omitempty"`
	...
	GuiDlpProfile                   *string                                  `json:"gui-dlp-profile,omitempty"`
	...
	GuiProxyInspection              *string                                  `json:"gui-proxy-inspection,omitempty"`
	...
	InternetServiceDatabaseCache    *string                                  `json:"internet-service-database-cache,omitempty"`
	Ip                              *string                                  `json:"ip,omitempty"`
	Ip6                             *string                                  `json:"ip6,omitempty"`
	LanExtensionControllerAddr      *string                                  `json:"lan-extension-controller-addr,omitempty"`
	...
	Nat46GenerateIpv6FragmentHeader *string                                  `json:"nat46-generate-ipv6-fragment-header,omitempty"`
	Nat64ForceIpv6PacketForwarding  *string                                  `json:"nat64-force-ipv6-packet-forwarding,omitempty"`
