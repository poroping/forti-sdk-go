...
const WirelessControllerVapMacFilterListPath = "wireless-controller/vap/mac-filter-list/"
...
const WirelessControllerVapPortalMessageOverridesPath = "wireless-controller/vap/portal-message-overrides/"
...
const WirelessControllerVapRadiusMacAuthUsergroupsPath = "wireless-controller/vap/radius-mac-auth-usergroups/"

type WirelessControllerVapRadiusMacAuthUsergroups struct {
	Name *string `json:"name,omitempty"`
}

const WirelessControllerVapSchedulePath = "wireless-controller/vap/schedule/"

type WirelessControllerVapSchedule struct {
	Name *string `json:"name,omitempty"`
}

const WirelessControllerVapSelectedUsergroupsPath = "wireless-controller/vap/selected-usergroups/"

type WirelessControllerVapSelectedUsergroups struct {
	Name *string `json:"name,omitempty"`
}

const WirelessControllerVapUsergroupPath = "wireless-controller/vap/usergroup/"

type WirelessControllerVapUsergroup struct {
	Name *string `json:"name,omitempty"`
}

const WirelessControllerVapVlanNamePath = "wireless-controller/vap/vlan-name/"
...
const WirelessControllerVapVlanPoolPath = "wireless-controller/vap/vlan-pool/"
