...
type WebProxyGlobal struct {
	...
	ForwardServerAffinityTimeout *float64                               `json:"forward-server-affinity-timeout,omitempty"`
	...
	MaxMessageLength             *float64                               `json:"max-message-length,omitempty"`
	MaxRequestLength             *float64                               `json:"max-request-length,omitempty"`
	MaxWafBodyCacheLength        *float64                               `json:"max-waf-body-cache-length,omitempty"`
