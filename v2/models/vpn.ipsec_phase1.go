...
const VpnIpsecPhase1BackupGatewayPath = "vpn.ipsec/phase1/backup-gateway/"

type VpnIpsecPhase1BackupGateway struct {
	Address *string `json:"address,omitempty"`
}

const VpnIpsecPhase1CertificatePath = "vpn.ipsec/phase1/certificate/"

type VpnIpsecPhase1Certificate struct {
	Name *string `json:"name,omitempty"`
}

const VpnIpsecPhase1Ipv4ExcludeRangePath = "vpn.ipsec/phase1/ipv4-exclude-range/"
...
const VpnIpsecPhase1Ipv6ExcludeRangePath = "vpn.ipsec/phase1/ipv6-exclude-range/"
