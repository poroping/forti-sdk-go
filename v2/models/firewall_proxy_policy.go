...
type FirewallProxyPolicy struct {
	...
	InternetService6Custom      *[]FirewallProxyPolicyInternetService6Custom      `json:"internet-service6-custom,omitempty"`
	InternetService6CustomGroup *[]FirewallProxyPolicyInternetService6CustomGroup `json:"internet-service6-custom-group,omitempty"`
	InternetService6Group       *[]FirewallProxyPolicyInternetService6Group       `json:"internet-service6-group,omitempty"`
	InternetService6Name        *[]FirewallProxyPolicyInternetService6Name        `json:"internet-service6-name,omitempty"`
