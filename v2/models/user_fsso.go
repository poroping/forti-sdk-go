...
type UserFsso struct {
	GroupPollInterval     *float64 `json:"group-poll-interval,omitempty"`
	Interface             *string  `json:"interface,omitempty"`
	InterfaceSelectMethod *string  `json:"interface-select-method,omitempty"`
	LdapPoll              *string  `json:"ldap-poll,omitempty"`
	LdapPollFilter        *string  `json:"ldap-poll-filter,omitempty"`
	LdapPollInterval      *float64 `json:"ldap-poll-interval,omitempty"`
	LdapServer            *string  `json:"ldap-server,omitempty"`
	LogonTimeout          *float64 `json:"logon-timeout,omitempty"`
	...
	Port2                 *float64 `json:"port2,omitempty"`
	Port3                 *float64 `json:"port3,omitempty"`
	Port4                 *float64 `json:"port4,omitempty"`
	Port5                 *float64 `json:"port5,omitempty"`
