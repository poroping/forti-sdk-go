...
type FirewallPolicy struct {
	...
	DiffservCopy                   *string                                         `json:"diffserv-copy,omitempty"`
	...
	InternetService6Custom         *[]FirewallPolicyInternetService6Custom         `json:"internet-service6-custom,omitempty"`
	InternetService6CustomGroup    *[]FirewallPolicyInternetService6CustomGroup    `json:"internet-service6-custom-group,omitempty"`
	InternetService6Group          *[]FirewallPolicyInternetService6Group          `json:"internet-service6-group,omitempty"`
	InternetService6Name           *[]FirewallPolicyInternetService6Name           `json:"internet-service6-name,omitempty"`
	...
	InternetService6SrcCustom      *[]FirewallPolicyInternetService6SrcCustom      `json:"internet-service6-src-custom,omitempty"`
	InternetService6SrcCustomGroup *[]FirewallPolicyInternetService6SrcCustomGroup `json:"internet-service6-src-custom-group,omitempty"`
	InternetService6SrcGroup       *[]FirewallPolicyInternetService6SrcGroup       `json:"internet-service6-src-group,omitempty"`
	InternetService6SrcName        *[]FirewallPolicyInternetService6SrcName        `json:"internet-service6-src-name,omitempty"`
	...
	NetworkServiceDynamic          *[]FirewallPolicyNetworkServiceDynamic          `json:"network-service-dynamic,omitempty"`
	NetworkServiceSrcDynamic       *[]FirewallPolicyNetworkServiceSrcDynamic       `json:"network-service-src-dynamic,omitempty"`
	...
	PolicyExpiryDateUtc            *string                                         `json:"policy-expiry-date-utc,omitempty"`
	...
	ReputationDirection6           *string                                         `json:"reputation-direction6,omitempty"`
	ReputationMinimum              *int64                                          `json:"reputation-minimum,omitempty"`
	ReputationMinimum6             *int64                                          `json:"reputation-minimum6,omitempty"`
	...
	ZtnaDeviceOwnership            *string                                         `json:"ztna-device-ownership,omitempty"`
	...
	ZtnaPolicyRedirect             *string                                         `json:"ztna-policy-redirect,omitempty"`
