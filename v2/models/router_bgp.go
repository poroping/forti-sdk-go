...
type RouterBgp struct {
	...
	AdditionalPathSelect            *float64                       `json:"additional-path-select,omitempty"`
	AdditionalPathSelect6           *float64                       `json:"additional-path-select6,omitempty"`
	...
	ConfederationIdentifier         *float64                       `json:"confederation-identifier,omitempty"`
	...
	DampeningMaxSuppressTime        *float64                       `json:"dampening-max-suppress-time,omitempty"`
	DampeningReachabilityHalfLife   *float64                       `json:"dampening-reachability-half-life,omitempty"`
	DampeningReuse                  *float64                       `json:"dampening-reuse,omitempty"`
	DampeningRouteMap               *string                        `json:"dampening-route-map,omitempty"`
	DampeningSuppress               *float64                       `json:"dampening-suppress,omitempty"`
	DampeningUnreachabilityHalfLife *float64                       `json:"dampening-unreachability-half-life,omitempty"`
	DefaultLocalPreference          *float64                       `json:"default-local-preference,omitempty"`
	DeterministicMed                *string                        `json:"deterministic-med,omitempty"`
	DistanceExternal                *float64                       `json:"distance-external,omitempty"`
	DistanceInternal                *float64                       `json:"distance-internal,omitempty"`
	DistanceLocal                   *float64                       `json:"distance-local,omitempty"`
	...
	GracefulRestartTime             *float64                       `json:"graceful-restart-time,omitempty"`
	GracefulStalepathTime           *float64                       `json:"graceful-stalepath-time,omitempty"`
	GracefulUpdateDelay             *float64                       `json:"graceful-update-delay,omitempty"`
	...
	KeepaliveTimer                  *float64                       `json:"keepalive-timer,omitempty"`
	...
	ScanTime                        *float64                       `json:"scan-time,omitempty"`
