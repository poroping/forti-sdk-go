...
type SwitchControllerManagedSwitch struct {
	...
	DhcpSnoopingStaticClient  *[]SwitchControllerManagedSwitchDhcpSnoopingStaticClient `json:"dhcp-snooping-static-client,omitempty"`
...
type SwitchControllerManagedSwitchPorts struct {
	...
	IgmpSnoopingFloodReports  *string                                            `json:"igmp-snooping-flood-reports,omitempty"`
	...
	McastSnoopingFloodTraffic *string                                            `json:"mcast-snooping-flood-traffic,omitempty"`
	...
	PoeModeBtCabable          *int64                                             `json:"poe-mode-bt-cabable,omitempty"`
	PoePortMode               *string                                            `json:"poe-port-mode,omitempty"`
	PoePortPower              *string                                            `json:"poe-port-power,omitempty"`
	PoePortPriority           *string                                            `json:"poe-port-priority,omitempty"`
	PoePreStandardDetection   *string                                            `json:"poe-pre-standard-detection,omitempty"`
