...
const VpnIpsecPhase1InterfaceBackupGatewayPath = "vpn.ipsec/phase1-interface/backup-gateway/"

type VpnIpsecPhase1InterfaceBackupGateway struct {
	Address *string `json:"address,omitempty"`
}

const VpnIpsecPhase1InterfaceCertificatePath = "vpn.ipsec/phase1-interface/certificate/"

type VpnIpsecPhase1InterfaceCertificate struct {
	Name *string `json:"name,omitempty"`
}

const VpnIpsecPhase1InterfaceIpv4ExcludeRangePath = "vpn.ipsec/phase1-interface/ipv4-exclude-range/"
...
const VpnIpsecPhase1InterfaceIpv6ExcludeRangePath = "vpn.ipsec/phase1-interface/ipv6-exclude-range/"
