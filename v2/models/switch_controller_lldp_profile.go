...
type SwitchControllerLldpProfile struct {
	...
	AutoIslHelloTimer     *float64                                         `json:"auto-isl-hello-timer,omitempty"`
	AutoIslPortGroup      *float64                                         `json:"auto-isl-port-group,omitempty"`
	AutoIslReceiveTimeout *float64                                         `json:"auto-isl-receive-timeout,omitempty"`
