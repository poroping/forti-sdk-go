...
type UserRadius struct {
	...
	RssoContextTimeout                     *float64                      `json:"rsso-context-timeout,omitempty"`
	...
	RssoLogPeriod                          *float64                      `json:"rsso-log-period,omitempty"`
	RssoRadiusResponse                     *string                       `json:"rsso-radius-response,omitempty"`
	RssoRadiusServerPort                   *float64                      `json:"rsso-radius-server-port,omitempty"`
	...
	SwitchControllerAcctFastFramedipDetect *float64                      `json:"switch-controller-acct-fast-framedip-detect,omitempty"`
