...
type RouterrouteMapRule struct {
	...
	MatchFlags                         *float64                                `json:"match-flags,omitempty"`
	...
	MatchMetric                        *float64                                `json:"match-metric,omitempty"`
	MatchOrigin                        *string                                 `json:"match-origin,omitempty"`
	MatchRouteType                     *string                                 `json:"match-route-type,omitempty"`
	MatchTag                           *float64                                `json:"match-tag,omitempty"`
	MatchVrf                           *float64                                `json:"match-vrf,omitempty"`
	SetAggregatorAs                    *float64                                `json:"set-aggregator-as,omitempty"`
	...
	SetDampeningMaxSuppress            *float64                                `json:"set-dampening-max-suppress,omitempty"`
	SetDampeningReachabilityHalfLife   *float64                                `json:"set-dampening-reachability-half-life,omitempty"`
	SetDampeningReuse                  *float64                                `json:"set-dampening-reuse,omitempty"`
	SetDampeningSuppress               *float64                                `json:"set-dampening-suppress,omitempty"`
	SetDampeningUnreachabilityHalfLife *float64                                `json:"set-dampening-unreachability-half-life,omitempty"`
	...
	SetFlags                           *float64                                `json:"set-flags,omitempty"`
	...
	SetLocalPreference                 *float64                                `json:"set-local-preference,omitempty"`
	SetMetric                          *float64                                `json:"set-metric,omitempty"`
	...
	SetRouteTag                        *float64                                `json:"set-route-tag,omitempty"`
	SetTag                             *float64                                `json:"set-tag,omitempty"`
	SetWeight                          *float64                                `json:"set-weight,omitempty"`
}
