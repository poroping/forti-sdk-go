...
const IpsSensorEntriesPath = "ips/sensor/entries/"
...
const IpsSensorEntriesCvePath = "ips/sensor/entries/cve/"

type IpsSensorEntriesCve struct {
	CveEntry *string `json:"cve-entry,omitempty"`
}

const IpsSensorEntriesExemptIpPath = "ips/sensor/entries/exempt-ip/"
...
const IpsSensorEntriesRulePath = "ips/sensor/entries/rule/"
