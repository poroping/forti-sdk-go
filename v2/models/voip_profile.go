...
type VoipProfileMsrp struct {
	...
	MaxMsgSize       *float64 `json:"max-msg-size,omitempty"`
...
type VoipProfileSccp struct {
	...
	LogViolations  *string  `json:"log-violations,omitempty"`
	MaxCalls       *float64 `json:"max-calls,omitempty"`
	Status         *string  `json:"status,omitempty"`
	VerifyHeader   *string  `json:"verify-header,omitempty"`
}

type VoipProfileSip struct {
	AckRate                          *float64 `json:"ack-rate,omitempty"`
	...
	ByeRate                          *float64 `json:"bye-rate,omitempty"`
	ByeRateTrack                     *string  `json:"bye-rate-track,omitempty"`
	CallKeepalive                    *float64 `json:"call-keepalive,omitempty"`
	CancelRate                       *float64 `json:"cancel-rate,omitempty"`
	...
	InfoRate                         *float64 `json:"info-rate,omitempty"`
	InfoRateTrack                    *string  `json:"info-rate-track,omitempty"`
	InviteRate                       *float64 `json:"invite-rate,omitempty"`
	...
	MaxBodyLength                    *float64 `json:"max-body-length,omitempty"`
	MaxDialogs                       *float64 `json:"max-dialogs,omitempty"`
	MaxIdleDialogs                   *float64 `json:"max-idle-dialogs,omitempty"`
	MaxLineLength                    *float64 `json:"max-line-length,omitempty"`
	MessageRate                      *float64 `json:"message-rate,omitempty"`
	...
	NotifyRate                       *float64 `json:"notify-rate,omitempty"`
