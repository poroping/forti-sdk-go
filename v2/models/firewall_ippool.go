...
type FirewallIppool struct {
	...
	ExcludeIp               *[]FirewallIppoolExcludeIp `json:"exclude-ip,omitempty"`
	...
	SubnetBroadcastInIppool *string                    `json:"subnet-broadcast-in-ippool,omitempty"`
...
type FirewallIppoolExcludeIp struct {
